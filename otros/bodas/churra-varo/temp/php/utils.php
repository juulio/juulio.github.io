...
function getRegalosByCategoria($idCategoria) {
...
/*--------------------------------------------------------------------------------------------
 * Funciones para el CMS regalos.php ---------------------------------------------------------
 */

// Consulta de las categorias para el select de categorias
...
function hayPaises() {
	$query = "SELECT COUNT(*) as cantidadPaises FROM `paises`";
	$mysql = mysql_query($query);
	$rowCantidadPaises = mysql_fetch_array($mysql);
	$cantidadPaises = $rowCantidadPaises['cantidadPaises'];
...
// Agregar un regalo
function agregarRegalo($nombreRegalo, $precioRegalo, $idCategoria) {
